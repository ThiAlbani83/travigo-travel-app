                ...
                <div className='grid items-center w-full max-w-2xl lg:text-center'>
                    ...
                    <div className='grid items-center grid-cols-3 gap-7 md:gap-3'>
                        {experience?.map((val, index) => (
                            <div key={index} className='bg-gradient-to-b from-emerald-500 to-green-300 rounded-lg h-auto 
                            w-auto flex items-center justify-center flex-col text-slate-900 text-center py-7 px-5 xl:p-5'>
                                <h1>
                                    {val.number}
                                </h1>
                                <p>
