                ...
                <div className='grid items-center w-full max-w-2xl lg:text-center'>
                    ...
                    <div className='grid items-center grid-cols-3 gap-7 xl:gap-3'>
                        {experience?.map((val, index) => (
                            ...
                            shadow-emerald-200 rounded-lg h-auto w-auto flex items-center justify-center 
                            flex-col text-slate-900 py-7 px-5 xl:p-5 filter cursor-pointer hover:scale-105 transition-transform duration-300'>
